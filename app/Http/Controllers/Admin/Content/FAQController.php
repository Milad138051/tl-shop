...
class FAQController extends Controller
{
    ...
    public function store(FaqRequest $request)
    {
      $inputs = $request->all();
      Faq::create($inputs);
      return redirect()->route('admin.content.faq.index')->with('swal-success', 'سوال جدید با موفقیت ذخیره شد');
    }
    ...
    public function update(FaqRequest $request, Faq $faq)
    {
      $inputs = $request->all();
      $faq->update($inputs);
      return redirect()->route('admin.content.faq.index')->with('swal-success', 'سوال شما با موفقیت ویرایش شد');
    }
    ...
    {
      $faq->delete();
      return redirect()->route('admin.content.faq.index')->with('swal-success','ایتم مورد نظر با موفقیت حذف شد ');
    }
