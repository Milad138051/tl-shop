...
class PageController extends Controller
{
    ...
    public function store(PageRequest $request)
    {
      ...
      $inputs = $request->all();
      Page::create($inputs);
      return redirect()->route('admin.content.page.index')->with('swal-success', 'پیج با موفقیت ساخته شد');
    }
    ...
    {
      $page->delete();
      return redirect()->route('admin.content.page.index')->with('swal-success','ایتم مورد نظر با موفقیت حذف شد ');
    }
