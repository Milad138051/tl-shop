...
class MenuController extends Controller
{
    ...
    public function store(MenuRequest $request)
    {
        $inputs = $request->all();
        Menu::create($inputs);
        return redirect()->route('admin.content.menu.index')->with('swal-success', 'منوی جدید با موفقیت ذخیره شد');
    }
    ...
    {
        $menu->delete();
        return redirect()->route('admin.content.menu.index')->with('swal-success','ایتم مورد نظر با موفقیت حذف شد ');
    }
