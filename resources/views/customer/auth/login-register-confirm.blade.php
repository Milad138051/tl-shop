...
<section class="vh-100 d-flex justify-content-center align-items-center pb-5">
    <form action="{{ route('auth.customer.login-register-confirm', $token) }}" method="post">
        @csrf
    <section class="login-wrapper mb-5">
        ...
        <section id="resend-otp" class="d-none">
            <a href="{{route('auth.customer.login-register-resend-otp',$token)}}" class="text-decoration-none text-primary">دریافت مجدد کد تایید</a>
        </section>
