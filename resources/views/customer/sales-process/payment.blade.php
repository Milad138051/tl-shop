                    ...
                    <section class="row mt-4">
                        ...
                        @endif
                                ...
                                <section class="row">
									...
									<form action="{{route('customer.sales-process.copanDiscount')}}" method="POST">
									@csrf
                            ...
                            <section class="content-wrapper bg-white p-3 rounded-2 mb-4">
                                ...
                                <form action="{{route('customer.sales-process.paymentSubmit')}}" method="POST" id="payment-submit">
								@csrf
