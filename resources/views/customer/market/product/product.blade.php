                            ...
                            <section class="product-info">
								...
								<!-- start favorite -->
                                    ...
                                    <section class="product-add-to-compare position-relative" style="top: 0">
                                        <button type="button" class="btn btn-light btn-sm text-decoration-none" data-url="{{ route('customer.market.add-to-compare', $product) }}" data-bs-toggle="tooltip" data-bs-placement="left" title="اضافه به لیست مقایسه">
                                        ...
                                        @auth
                                            ...
                                            <section class="product-add-to-compare position-relative" style="top: 0">
                                                <button type="button" class="btn btn-light btn-sm text-decoration-none" data-url="{{ route('customer.market.add-to-compare', $product) }}" data-bs-toggle="tooltip" data-bs-placement="left" title="حذف از لیست مقایسه">
...
@include('customer.layouts.partials.related-product')
                    ...
                    <section class="py-4">
                        ...
                        <section class="product-comments mb-4">
                            ...
                            <section class="product-comment">
                                <section class="product-comment-header d-flex justify-content-start">
									...
									<section class="product-comment-title">
									<button class="btn btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#add-replay" ><i class="fa fa-plus"></i> پاسخ به این دیدگاه</button>
							
							<!-- start add replay Modal -->
                                <section class="modal fade" id="add-replay" tabindex="-1" aria-labelledby="add-comment-label" aria-hidden="true">
                                    
									<section class="modal-dialog">
                                        <section class="modal-content">
                                            <section class="modal-header">
                                                <h5 class="modal-title" id="add-comment-label"><i class="fa fa-plus"></i>دیدگاه</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </section>
                                            @guest
                                                <section class="modal-body">
                                            ...
                                            <section class="modal-body">
                                                <form class="row" action="{{ route('customer.market.add-replay',[ $product,$activeComment]) }}" method="post">
                                                    @csrf
                                                    <section class="col-12 mb-2">
                                                        <label for="comment" class="form-label mb-1">دیدگاه شما</label>
                                                        <textarea class="form-control form-control-sm" id="comment" placeholder="دیدگاه شما ..." rows="4" name="body"></textarea>
                        ...
                        <section class="product-rating mb-4">
                            ...
                            <div class="container">
                                ...
                                <h6>
                                    تعداد افراد شرکت کننده : {{ $product->ratingsCount() ?? 'شما اولین امتیاز را ثبت
                                    نمایید!!!' }}
                                </h6>
                            </div>
						...
						@else 
						   <section id="rating" class="content-header mt-2 mb-4">
							...
							<h4>برای ثبت امتیاز باید ابتدا ان را خریداری کنید</h4>
                        @endif
                        @endauth
                        @guest
                        <section class="modal-body">
...
<section class="position-fixed p-4 flex-row-reverse" style="z-index: 909999999; left: 239px; top: 3rem; width: 26rem; max-width: 80%;">
