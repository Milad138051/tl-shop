...
@section('content')
            ...
            <section class="col-md-8 pe-md-1 ">
                <section id="slideshow" class="owl-carousel owl-theme">
                    ...
                    @foreach ($slideShowImages as $slideShowImage)
					 ...
					 <section class="item"><a class="w-100 d-block h-auto text-decoration-none" href="{{ urldecode($slideShowImage->url) }}"><img class="w-100 rounded-2 d-block h-auto" src="{{ asset($slideShowImage->image) }}" alt="{{ $slideShowImage->title }}"></a></section>
    ...
    <section class="position-fixed p-4 flex-row-reverse" style="z-index: 909999999; left: 10px; top: 19rem; width: 26rem; max-width: 80%;">
