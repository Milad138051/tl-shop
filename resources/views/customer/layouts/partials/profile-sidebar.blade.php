     		   ...
     		   <section class="content-wrapper bg-white p-3 rounded-2 mb-3">
                    ...
                    <section class="sidebar-nav">
                        ...
                        <section class="sidebar-nav-item">
                            ...
                            <section class="sidebar-nav-item">
                            <span class="sidebar-nav-item-title"><a class="p-3" href="{{route('customer.profile.my-tickets')}}">تیکت های
                                    من</a></span>
                        </section>
                        <section class="sidebar-nav-item">
                            <span class="sidebar-nav-item-title"><a class="p-3" href={{route('customer.profile.my-favorites')}}>لیست علاقه
                                    مندی</a></span>
                        </section>       
						<section class="sidebar-nav-item">
                            <span class="sidebar-nav-item-title"><a class="p-3" href={{route('customer.profile.my-compares')}}>لیست مقایسه های من</a></span>
                        </section>
                        <section class="sidebar-nav-item">
