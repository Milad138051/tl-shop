                        ...
                        @forelse (auth()->user()->products as $product)
					     ...
					     <section class="cart-item d-flex py-3">
                            ...
                            <section class="align-self-start w-100">
                                <a href="{{route('customer.market.product',$product->id)}}" class="fw-bold">{{$product->name}}</a>
                                <section>
                                    <a class="text-decoration-none cart-delete" href="{{ route('customer.profile.my-favorites.delete', $product) }}"><i class="fa fa-trash-alt"></i> حذف از لیست علاقه ها</a>
                                </section>
                            </section>
