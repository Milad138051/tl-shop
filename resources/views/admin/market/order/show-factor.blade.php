                        ...
                        <tr class="table-primary">
                            ...
                            <td class="width-8-rem text-left">
                                <a href="" class="btn btn-dark btn-sm text-white" id="print">
                                 ...
                                 <a href="{{route('admin.market.order.show-factor/detail',$order->id)}}" class="btn btn-warning btn-sm">
                           ...
                           <tr class="border-bottom">
                            ...
                            <td class="text-left font-weight-bolder">
                                {{ $order->order_final_amount ?? '-' }} تومان
                            </td>
                        </tr>
                           <tr class="border-bottom">
                            <th>مجموع تمامی مبلغ تخفیفات</th>
                            <td class="text-left font-weight-bolder">
                                {{ $order->order_discount_amount ?? '-' }} تومان
                            </td>
                        </tr>
                           <tr class="border-bottom">
