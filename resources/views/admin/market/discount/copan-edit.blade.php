                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{old('start_date',$copan->start_date)}}" name="start_date" id="start_date" class="form-control form-control-sm d-none">
                                <input type="text" value="{{old('start_date',$copan->start_date)}}" id="start_date_view" class="form-control form-control-sm">
                            </div>
                            @error('start_date')
                            <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                <strong>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{old('end_date',$copan->end_date)}}" name="end_date" id="end_date" class="form-control form-control-sm d-none">
                                <input type="text" value="{{old('end_date',$copan->end_date)}}"  id="end_date_view" class="form-control form-control-sm">
                            </div>
                            @error('end_date')
                            <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                <strong>
