                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input name="name" type="text" class="form-control form-control-sm" value="{{old('name',$categoryAttribute->name)}}">
                            </div>
							  @error('name')
						...
						<section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input  name="unit" type="text" class="form-control form-control-sm" value="{{old('unit',$categoryAttribute->unit)}}">
                            </div>
							  @error('name')
                                <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                    <strong>
                        ...
                        <section class="col-12">
                            <div class="form-group">
                                ...
                                <select name="category_id" id="" class="form-control form-control-sm">
                                    ...
                                    <option value="{{$productCategory->id}}" @if(old('category_id',$categoryAttribute->category_id) == $productCategory->id) selected @endif>
