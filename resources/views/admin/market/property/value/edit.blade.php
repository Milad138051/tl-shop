                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="value" value="{{ old('value',json_decode($categoryValue->value)->value) }}" class="form-control form-control-sm">
                            </div>
                            @error('value')
                            <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                <strong>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="price_increase" value="{{old('price_increase',json_decode($categoryValue->value)->price_increase)}}" class="form-control form-control-sm">
                            </div>
