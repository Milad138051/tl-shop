                    ...
                    <section class="row">
					    ...
					    <section class="col-12 mb-3">
                            <div class="form-group">
                                ...
                                <select name="type" id="type" class="form-control form-control-sm" id="type">
                                    <option value="0" @if (old('type',$emailfile->type) == 0) selected @endif>معمولی</option>
                                    <option value="1" @if (old('type',$emailfile->type) == 1) selected @endif>محرمانه</option>
                                </select>
                            </div>
                            @error('type')
