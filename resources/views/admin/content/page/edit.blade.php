    ...
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                <a href="{{ route('admin.content.page.update',$page->id) }}" class="btn btn-info btn-sm">بازگشت</a>
            </section>
                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text"  name="title" class="form-control form-control-sm" id="title" value="{{old('page',$page->title)}}">
                            </div>
